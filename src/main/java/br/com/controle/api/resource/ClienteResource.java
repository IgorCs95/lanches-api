...
import br.com.controle.api.repository.ClienteRepository;
...
//	private ClienteService clienteService;
	...
	@GetMapping
	public List<Cliente> getAll(ClienteFilter clienteFilter) {
		return clienteRepository.filtrar(clienteFilter);
	}

	@PostMapping
	public ResponseEntity<?> create(@Validated @RequestBody Cliente cliente, HttpServletResponse response) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Cliente> update(@Validated @PathVariable long id, @RequestBody Cliente cliente) {
